...
def minkloc_improve_multimodal(weights: Optional[Union[str, Path]] = None) -> ComposedModel:
    """Default MinkLoc++ model configuration.
    ...
    model_config = DictConfig(
        {
            "_target_": "opr.models.base_models.ComposedImprovedModel",
            "image_module": {
                "_target_": "opr.models.base_models.ImageModule",
                "backbone": {
                    "_target_": "opr.models.resnet.ResNet18FPNExtractor",
...
def minkloc_nlp_improve_multimodal(weights: Optional[Union[str, Path]] = None) -> ComposedModel:
    """Default MinkLoc++ model configuration.
